                ...
                <TableRow key={intervention.id}>
                  ...
                  <TableCell className="tableCell">
                    {intervention.conversation ? (
                      <Link to={`/conversation/${intervention.conversation.id}/technicien/${userId}`} onClick={handleClose}>
...
export default MessagePopupTechnicien;
