          ...
          path('refuser/', views.refuser, name='refuser'),
           ...
           path('active/', views.activer, name='active'),
            ...
            path('enterprise/<int:en_id>/users',views.CustomerListe,name="cc"),
             ...
             path('enterprise/<int:enterprise_id>/intervention/',views.intervention),
            ...
            path("createservice",views.create_service,name="createservice"),
             ...
             path('enterprise/<int:en_id>/chefservice/<int:user_id>/equipements', views.equipement_list),
              path('equipements/<int:pk>/', views.equipement_detail),
              path("enterprise/<int:en_id>/chefservice/<int:user_id>/equipment/create",views.api_create_equipment),
               ...
               path('login_react/', views.loginn ,name="login_react"),
                ...
                path("conversation/<int:conversation_id>/messages/",views.conversationmessage),
                 ...
                 path("delete_service/<int:id>/",views.api_delete_service),
                  ...
                  path("enterprise/<int:en_id>/chefservice/<int:user_id>/techniciens",views.api_liste_technicien_par_service),
                  path("api_liste_notification_unread/<int:user_id>/",views.api_liste_notification_unread),
                  path ("api_notification_liste/<int:user_id>/",views.api_notification_liste),
                  path("api_notification_change/<int:user_id>/",views.api_change_statu_notification),
                  path("user/<int:user_id>/notifications/",views.api_all_nofication),
                  ...
                  path("api_change_password/<int:user_id>/",views.api_change_password),
                   ...
                   path("put_equimpetment/<int:equipment_id>/",views.api_update_equipment),
                    ...
                    path("enterprise/<int:enterprise_id>/technicien/<int:user_id>/upgrade",views.updrade_technicien_to_chef_service),
                    ...
                    path("enterprise/<int:en_id>/rapport/create/",views.api_create_rapport),
                    path("generate/rapport/<int:rapport_id>/",views.api_generate_pdf),
                    path("enterprise/<int:en_id>/chefservice/<int:user_id>/intervention/create",views.api_create_intervention_preventive),
